...
If you want to use a microcomputer or file system for which no presets are provided, you have to write a program.  
...
A step-by-step implementation example is shown below.  
The hardware will use M5Stack and assume reading from an SD card.  
...
See the sample code for a complete example.  
